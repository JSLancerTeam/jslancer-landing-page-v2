...
const About: FC = () => (
  <SectionContainer>
    ...
    <StyledSectionContent>
      ...
      <TextContent>
        <Desc>
        Started in 2015, JSLancer is a software development consultant from Vietnam 
        that helps our clients build the advanced user interface and data visualization products.
        </Desc>
        <Desc>
          Our close-knit team consists of experienced engineers who 
          can tackle complex challenges and bring the best solution for your product, 
